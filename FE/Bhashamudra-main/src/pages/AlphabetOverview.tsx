...
const AlphabetOverview = () => {
  ...
  const completedLetters = 1;
  const progressPercentage = (completedLetters / totalLetters) * 100;
  
  const letters = Array.from('ABCDEFGHIJKLMNOPQRSTUVWXYZ').map((letter) => ({
    letter,
    isCompleted: letter.charCodeAt(0) - 65 < completedLetters,
  }));
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-[#004748] mb-4">
            ISL Alphabet Journey
          </h1>
          {/* <p className="text-[#004748]/80 text-lg max-w-2xl mx-auto mb-8">
            Master the Indian Sign Language alphabet through our interactive lessons.
          </p> */}
          ...
          <div className="max-w-2xl mx-auto mb-12">
            ...
            <div className="text-sm text-[#004748]/70 mt-2">
              {completedLetters} of {totalLetters} letters mastered
            </div>
          </div>
        </div>
        ...
        >
          {letters.map(({ letter, isCompleted }) => (
            <motion.div
              key={letter}
            ...
            >
              <button
                onClick={() => navigate(`/learn/letter/${letter}`)}
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className={`text-3xl font-medium transition-transform
